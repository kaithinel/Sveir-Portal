[➡️ Sveir.xyz](https://Sveir.xyz) - 网址导航
===

这是一个纯静态的网址导航网站，由[viggo](http://viggoz.com)开发收集并整理，Sveir在其基础上修改而成。项目基于bootstrap前端框架开发。

![](http://www.sveir.xyz/assets/images/preview.gif)

这是一个开源的公益项目，你可以拿来制作自己的网址导航，也可以做与导航无关的网站。如果你有任何疑问，可以通过开发者个人网站[viggoz.com](http://viggoz.com)中的联系方式找到他，欢迎与他交流分享。
